...
public class LibraryManagementSystem {
    ...
    private static void printStats(Library l) {
        System.out.println("전체 도서 수: " + l.getTotalBooks());
        System.out.println("대출 가능 도서 수: " + l.getAvailableBooksCount());
        System.out.println("대출 중인 도서 수: " + l.getBorrowedBooksCount());
    }
}
